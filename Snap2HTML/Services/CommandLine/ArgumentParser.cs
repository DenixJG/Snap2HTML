...
public class Arguments
{
    ...
    public static string[] SplitCommandLine(string commandLine)
    {
        ...
        var toReturn = translatedArguments.ToString().Split(['\n'], StringSplitOptions.RemoveEmptyEntries);
        ...
        foreach (var argument in arguments)
        {
            ...
            switch (parts.Length)
            {
                ...
                case 2:
                    ...
                    //Because of the split index 0 will be an empty string
                    _waitingParameter = parts[1];
                    break;
                case 3:
                    AddWaitingArgumentAsFlag();
                    //Because of the split index 0 will be an empty string
                    var valuesWithoutQuotes = RemoveMatchingQuotes(parts[2]);
